...
public class ExtractionRuleBeanInfo extends MySimpleBeanInfo {
    
	public ExtractionRuleBeanInfo() {
		try {
			beanClass = ExtractionRule.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.DatabaseObject.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/core/images/extractionrule_color_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/core/images/extractionrule_color_32x32.gif";
            ...
            properties[0] = new PropertyDescriptor("isEnabled", ExtractionRule.class, "isEnabled", "setEnabled");
