...
public class SheetBeanInfo extends MySimpleBeanInfo {
	...
	public SheetBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/core/images/sheet_color_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/core/images/sheet_color_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/core/res/Sheet");
