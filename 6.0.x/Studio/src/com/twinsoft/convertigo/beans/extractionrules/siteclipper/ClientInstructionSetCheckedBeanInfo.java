...
public class ClientInstructionSetCheckedBeanInfo extends MySimpleBeanInfo {
	...
	public ClientInstructionSetCheckedBeanInfo() {
		try {
		    ...
		    iconNameC16 = "/com/twinsoft/convertigo/beans/extractionrules/siteclipper/images/rule_clientinstructionsetchecked_color_16x16.gif";
		    iconNameC32 = "/com/twinsoft/convertigo/beans/extractionrules/siteclipper/images/rule_clientinstructionsetchecked_color_32x32.gif";

			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/extractionrules/siteclipper/res/ClientInstructionSetChecked");
