...
public class ContinueWithSiteClipperStatementBeanInfo extends MySimpleBeanInfo {
    
	public ContinueWithSiteClipperStatementBeanInfo() {
		try {
			beanClass = ContinueWithSiteClipperStatement.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.Statement.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/statements/images/ContinueWithSiteClipperStatement_color_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/statements/images/ContinueWithSiteClipperStatement_color_32x32.gif";
