...
public class InputHtmlSetCheckedStatementBeanInfo extends MySimpleBeanInfo {
	...
	public InputHtmlSetCheckedStatementBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/statements/images/inputhtmlsetchecked_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/statements/images/inputhtmlsetchecked_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/statements/res/InputHtmlSetCheckedStatement");
