...
public class ReturnStatementBeanInfo extends MySimpleBeanInfo {
	...
	public ReturnStatementBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/statements/images/return_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/statements/images/return_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/statements/res/ReturnStatement");
