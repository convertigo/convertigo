...
public class IsInThenElseStepBeanInfo extends MySimpleBeanInfo {
    
	public IsInThenElseStepBeanInfo() {
		try {
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/IsInThenElseStep");
