...
public class ListDirStepBeanInfo extends MySimpleBeanInfo {
	...
	public ListDirStepBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/listdir_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/listdir_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/ListDirStep");
