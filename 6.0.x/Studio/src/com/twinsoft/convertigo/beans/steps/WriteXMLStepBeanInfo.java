...
public class WriteXMLStepBeanInfo extends MySimpleBeanInfo{
	...
	public WriteXMLStepBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/xmlW_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/xmlW_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/WriteXMLStep");
