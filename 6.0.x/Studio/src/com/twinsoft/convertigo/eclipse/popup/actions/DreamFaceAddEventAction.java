...
public class DreamFaceAddEventAction extends DreamFaceAbstractAction {

	public DreamFaceAddEventAction() {
		super();
	}
	...
	public void run() {
        ...
        try {
    		...
    		if (explorerView != null) {
    			...
    			MashupEventDialog mashupDialog = new MashupEventDialog(shell, MashupEventDialog.TYPE_ADD, mdc, mec);
	        	mashupDialog.open();
	    			...
	    			if ((dataview != null) && (!dataview.equals(""))) {
	    				if (securedLogin()) {
		    				try {
				    			...
				    			String dfResponse = addResponseEvent(requestable, dataview);
        	...
        	ConvertigoPlugin.logException(e, "Unable to add event(s) to DreamFace!");
        }
        finally {
	...
	private String addResponseEvent(RequestableObject requestable, String dataview) throws HttpException, IOException, ParserConfigurationException, SAXException, DreamFaceInvalidTemplateException {
		Hashtable<String, String> fields = getResponseFields(ADD_EVENT_TYPE, requestable, dataview);
