...
public class DreamFaceUpdateEventAction extends DreamFaceAbstractAction {

	public DreamFaceUpdateEventAction() {
		super();
	}
	...
	public void run() {
        ...
        try {
    		...
    		if (explorerView != null) {
    			...
    			MashupEventDialog mashupDialog = new MashupEventDialog(shell, MashupEventDialog.TYPE_UPDATE, mdc, mec);
	        	mashupDialog.open();
	    			...
	    			if ((dataview != null) && (!dataview.equals(""))) {
	    				if (securedLogin()) {
		    				try {
				    			...
				    			String dfResponse = updateResponseEvent(requestable, dataview);
	...
	private String updateResponseEvent(RequestableObject requestable, String dataview) throws HttpException, IOException, ParserConfigurationException, SAXException, DreamFaceInvalidTemplateException {
		Hashtable<String, String> fields = getResponseFields(UPDATE_EVENT_TYPE, requestable, dataview);
