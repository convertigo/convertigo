...
public class HttpTransactionEditor extends TransactionWithVariablesEditor {
	static public String[] getColumnNames() {
		return new String[] { "Variable", "Description", "Default value", "WSDL", "Multi", "Personalizable", "Cached key", "Method", "HTTP variable" };
	}
	
	static public Object[] getDefaultData() {
		return new Object[] { "variable", "description", "", Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, "GET", "" };
	}
