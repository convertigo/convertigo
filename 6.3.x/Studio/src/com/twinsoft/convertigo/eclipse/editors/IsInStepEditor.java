...
public class IsInStepEditor {
	static public String[] getColumnNames() {
		return new String[] { "Operator", "Regular exp"};
	}
	...
	static public CellEditor[] getColumnEditor(Composite parent) {
		CellEditor[] columnEditors = new CellEditor[2];
    	columnEditors[0] = new ComboBoxCellEditor(parent, new String[]{"AND","NOT"});
