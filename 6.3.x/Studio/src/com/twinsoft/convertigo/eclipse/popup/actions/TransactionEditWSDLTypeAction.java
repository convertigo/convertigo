...
public class TransactionEditWSDLTypeAction extends MyAbstractAction {

	public TransactionEditWSDLTypeAction() {
		super();
	}
	...
	public void run() {
		...
		try {
			...
			ConvertigoPlugin.logException(e, "Unable to edit the WSDL for transaction!");
		} finally {
