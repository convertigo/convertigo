...
- [#196](https://github.com/convertigo/convertigo/issues/196) MobileBuilder, avoided empty value for properties in TS or SC mode to prevent build failure

#### Bug Fixes:

- [#182](https://github.com/convertigo/convertigo/issues/182) Fixed, can now upload file variable in Test Platform
...
- [#197](https://github.com/convertigo/convertigo/issues/197) Fixed, re-introduce the fake sapjco3.jar to replace with the real sapjco3.jar
