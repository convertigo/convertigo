...
public class MergeBlocksBeanInfo extends MySimpleBeanInfo {
	...
	public MergeBlocksBeanInfo() {
		try {
		    ...
		    iconNameC16 = "/com/twinsoft/convertigo/beans/common/images/mergeblocks_color_16x16.gif";
		    iconNameC32 = "/com/twinsoft/convertigo/beans/common/images/mergeblocks_color_32x32.gif";

			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/common/res/MergeBlocks");
