...
public class RegularExpressionBeanInfo extends MySimpleBeanInfo {
    ...
    public RegularExpressionBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/common/images/regularexpression_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/common/images/regularexpression_color_32x32.png";

			resourceBundle = getResourceBundle("res/RegularExpression");
