...
public class ProxyHttpConnectorBeanInfo extends MySimpleBeanInfo {
	...
	public ProxyHttpConnectorBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/connectors/images/proxyhttpconnector_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/connectors/images/proxyhttpconnector_color_32x32.png";

			resourceBundle = getResourceBundle("res/ProxyHttpConnector");
