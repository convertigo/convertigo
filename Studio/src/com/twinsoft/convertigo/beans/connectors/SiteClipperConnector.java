...
//					
//					String user = givenAuthUser;
//					String password = givenAuthPassword;
//					String host = hostConfiguration != null ? hostConfiguration.getHost() : shuttle.getRequest(QueryPart.host);
//					
//					AuthenticationMode.get(givenAuthMode).setCredentials(context.httpState, user, password, host, domain);
//				} else {
