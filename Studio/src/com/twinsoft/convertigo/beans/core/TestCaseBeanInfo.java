...
public class TestCaseBeanInfo extends MySimpleBeanInfo {
    
	public TestCaseBeanInfo() {
		try {
			beanClass = TestCase.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.DatabaseObject.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/core/images/testcase_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/core/images/testcase_color_32x32.png";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/core/res/TestCase");
