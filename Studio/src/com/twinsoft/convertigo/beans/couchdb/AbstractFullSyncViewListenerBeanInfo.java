...
public class AbstractFullSyncViewListenerBeanInfo extends MySimpleBeanInfo {

	public AbstractFullSyncViewListenerBeanInfo() {
		try {
			beanClass =  AbstractFullSyncViewListener.class;
			...
			resourceBundle = getResourceBundle("res/AbstractFullSyncViewListener");
