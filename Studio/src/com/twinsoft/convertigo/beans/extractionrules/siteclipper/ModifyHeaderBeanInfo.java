...
public class ModifyHeaderBeanInfo extends MySimpleBeanInfo {

	public ModifyHeaderBeanInfo() {
		try {
			beanClass = ModifyHeader.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.extractionrules.siteclipper.Header.class;
	
		    iconNameC16 = "/com/twinsoft/convertigo/beans/extractionrules/siteclipper/images/rule_modifyheader_color_16x16.gif";
		    iconNameC32 = "/com/twinsoft/convertigo/beans/extractionrules/siteclipper/images/rule_modifyheader_color_32x32.gif";
