...
public class RemoveHeaderFromResponse extends RemoveHeader implements IResponseRule {

	private static final long serialVersionUID = -612672017104825166L;

	public RemoveHeaderFromResponse() {
		super();
	}
