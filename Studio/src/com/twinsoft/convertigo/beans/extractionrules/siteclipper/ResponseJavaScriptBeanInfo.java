 ...
 *
 * $URL: http://sourceus/svn/convertigo/CEMS_opensource/branches/6.2.x/Studio/src/com/twinsoft/convertigo/beans/extractionrules/siteclipper/AddHeaderToResponseBeanInfo.java $
 * $Author: laetitiam $
 * $Revision: 31301 $
...
public class ResponseJavaScriptBeanInfo extends MySimpleBeanInfo {

	public ResponseJavaScriptBeanInfo() {
		try {
			beanClass = ResponseJavaScript.class;
