...
public class UIAttributeBeanInfo extends MySimpleBeanInfo {
	...
	public UIAttributeBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/mobile/components/images/uiattribute_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/mobile/components/images/uiattribute_color_32x32.png";
			...
			properties[1] = new PropertyDescriptor("attrValue", beanClass, "getAttrValue", "setAttrValue");
