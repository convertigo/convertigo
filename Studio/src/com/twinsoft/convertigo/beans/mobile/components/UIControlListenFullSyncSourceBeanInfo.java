...
public class UIControlListenFullSyncSourceBeanInfo extends MySimpleBeanInfo {
	
	public UIControlListenFullSyncSourceBeanInfo() {
		try {
			beanClass = UIControlListenFullSyncSource.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.mobile.components.UIControlListenSource.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/mobile/components/images/uicontrollistenfullsyncsource_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/mobile/components/images/uicontrollistenfullsyncsource_color_32x32.png";

			resourceBundle = getResourceBundle("res/UIControlListenFullSyncSource");
