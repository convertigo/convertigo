...
public class AbstractLocalXsdReferenceBeanInfo extends MySimpleBeanInfo {
	public AbstractLocalXsdReferenceBeanInfo() {
		try {
			beanClass = AbstractLocalXsdReference.class;
