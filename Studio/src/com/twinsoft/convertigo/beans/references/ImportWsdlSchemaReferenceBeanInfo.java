...
public class ImportWsdlSchemaReferenceBeanInfo extends MySimpleBeanInfo {
	public ImportWsdlSchemaReferenceBeanInfo() {
		try {
			beanClass = ImportWsdlSchemaReference.class;
