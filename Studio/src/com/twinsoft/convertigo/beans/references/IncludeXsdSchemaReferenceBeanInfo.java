...
public class IncludeXsdSchemaReferenceBeanInfo extends MySimpleBeanInfo {
	public IncludeXsdSchemaReferenceBeanInfo() {
		try {
			beanClass = IncludeXsdSchemaReference.class;
