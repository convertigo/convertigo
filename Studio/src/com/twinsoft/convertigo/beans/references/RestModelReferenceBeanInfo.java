...
public class RestModelReferenceBeanInfo extends MySimpleBeanInfo {
	public RestModelReferenceBeanInfo() {
		try {
			beanClass = RestModelReference.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.references.RemoteFileReference.class;

			resourceBundle = getResourceBundle("res/RestModelReference");
