...
public class HtmlScreenClassBeanInfo extends MySimpleBeanInfo {
    
	public HtmlScreenClassBeanInfo() {
		try {
			beanClass = HtmlScreenClass.class;
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/screenclasses/res/HtmlScreenClass");
