...
public class SiteClipperScreenClassBeanInfo extends MySimpleBeanInfo {

	public SiteClipperScreenClassBeanInfo() {
		try {
			beanClass = SiteClipperScreenClass.class;
			...
			resourceBundle = getResourceBundle("res/SiteClipperScreenClass");
