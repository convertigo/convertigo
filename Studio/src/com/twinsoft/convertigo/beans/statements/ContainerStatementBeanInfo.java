...
public class ContainerStatementBeanInfo extends MySimpleBeanInfo {
    
	public ContainerStatementBeanInfo() {
		try {
			...
			resourceBundle = getResourceBundle("res/ContainerStatement");
