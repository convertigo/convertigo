...
public class IfXpathExistsStatementBeanInfo extends MySimpleBeanInfo {

	public IfXpathExistsStatementBeanInfo() {
		try {
			beanClass = IfXpathExistsStatement.class;
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/statements/res/IfXpathExistsStatement");
