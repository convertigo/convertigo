...
public class InvokeBrowserJsStatementBeanInfo extends MySimpleBeanInfo {
	...
	public InvokeBrowserJsStatementBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/statements/images/invokebrowserjs_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/statements/images/invokebrowserjs_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/statements/res/InvokeBrowserJsStatement");
