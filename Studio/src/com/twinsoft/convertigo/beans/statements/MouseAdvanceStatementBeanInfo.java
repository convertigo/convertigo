...
public class MouseAdvanceStatementBeanInfo extends MySimpleBeanInfo {
	...
	public MouseAdvanceStatementBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/statements/images/mouseadvance_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/statements/images/mouseadvance_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/statements/res/MouseAdvanceStatement");
