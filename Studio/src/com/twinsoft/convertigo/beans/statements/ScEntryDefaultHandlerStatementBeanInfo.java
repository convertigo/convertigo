...
public class ScEntryDefaultHandlerStatementBeanInfo extends MySimpleBeanInfo {
    
	public ScEntryDefaultHandlerStatementBeanInfo() {
		try {
			...
			resourceBundle = getResourceBundle("res/ScEntryDefaultHandlerStatement");
