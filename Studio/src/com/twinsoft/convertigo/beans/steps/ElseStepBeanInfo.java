...
public class ElseStepBeanInfo extends MySimpleBeanInfo {
    
	public ElseStepBeanInfo() {
		try {
			beanClass = ElseStep.class;
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/ElseStep");
