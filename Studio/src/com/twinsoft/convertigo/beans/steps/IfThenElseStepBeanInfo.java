...
public class IfThenElseStepBeanInfo extends MySimpleBeanInfo {
    
	public IfThenElseStepBeanInfo() {
		try {
			beanClass = IfThenElseStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.steps.IfStep.class;
