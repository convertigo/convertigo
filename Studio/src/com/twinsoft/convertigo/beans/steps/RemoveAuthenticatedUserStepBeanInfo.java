...
public class RemoveAuthenticatedUserStepBeanInfo extends MySimpleBeanInfo {
	...
	public RemoveAuthenticatedUserStepBeanInfo() {
		try {
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/RemoveAuthenticatedUserStep");
