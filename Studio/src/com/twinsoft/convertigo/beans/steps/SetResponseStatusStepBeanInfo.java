...
public class SetResponseStatusStepBeanInfo extends MySimpleBeanInfo {

	public SetResponseStatusStepBeanInfo() {
		try {
			beanClass = SetResponseStatusStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.Step.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/setResponseStatus_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/setResponseStatus_32x32.png";
			
			resourceBundle = getResourceBundle("res/SetResponseStatusStep");
