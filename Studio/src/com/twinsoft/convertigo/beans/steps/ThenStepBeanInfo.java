...
public class ThenStepBeanInfo extends MySimpleBeanInfo {
    
	public ThenStepBeanInfo() {
		try {
			beanClass = ThenStep.class;
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/ThenStep");
