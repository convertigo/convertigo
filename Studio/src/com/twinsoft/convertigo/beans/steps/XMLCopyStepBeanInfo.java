...
public class XMLCopyStepBeanInfo extends MySimpleBeanInfo {
    
	public XMLCopyStepBeanInfo() {
		try {
			beanClass = XMLCopyStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.Step.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/copystep_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/copystep_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/XMLCopyStep");
