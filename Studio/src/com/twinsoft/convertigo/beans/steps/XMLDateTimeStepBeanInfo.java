...
public class XMLDateTimeStepBeanInfo extends MySimpleBeanInfo {
	...
	public XMLDateTimeStepBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/datetime_16x16.gif";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/datetime_32x32.gif";
			
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/steps/res/XMLDateTimeStep");
