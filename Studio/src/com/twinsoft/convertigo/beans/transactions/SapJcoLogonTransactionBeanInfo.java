...
public class SapJcoLogonTransactionBeanInfo extends MySimpleBeanInfo {

	public SapJcoLogonTransactionBeanInfo() {
		try {
			...
			resourceBundle = java.util.ResourceBundle.getBundle("com/twinsoft/convertigo/beans/transactions/res/SapJcoLogonTransaction");
