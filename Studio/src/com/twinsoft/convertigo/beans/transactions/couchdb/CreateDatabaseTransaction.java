...
public class CreateDatabaseTransaction extends AbstractDatabaseTransaction {

	private static final long serialVersionUID = 6809890813346670619L;
	
	public CreateDatabaseTransaction() {
		super();
	}

	@Override
	public CreateDatabaseTransaction clone() throws CloneNotSupportedException {
		CreateDatabaseTransaction clonedObject =  (CreateDatabaseTransaction) super.clone();
		return clonedObject;
	}
