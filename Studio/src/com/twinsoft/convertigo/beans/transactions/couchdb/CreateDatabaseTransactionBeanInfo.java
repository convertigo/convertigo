...
public class CreateDatabaseTransactionBeanInfo extends MySimpleBeanInfo {

	public CreateDatabaseTransactionBeanInfo() {
		try {
			beanClass = CreateDatabaseTransaction.class;
			additionalBeanClass = AbstractDatabaseTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/CreateDatabaseTransaction");
