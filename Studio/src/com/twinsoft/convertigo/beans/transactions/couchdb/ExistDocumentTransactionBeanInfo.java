...
public class ExistDocumentTransactionBeanInfo extends MySimpleBeanInfo {

	public ExistDocumentTransactionBeanInfo() {
		try {
			beanClass = ExistDocumentTransaction.class;
			additionalBeanClass = AbstractDocumentTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/ExistDocumentTransaction");
