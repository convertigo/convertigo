...
public class GetDocumentAttachmentTransactionBeanInfo extends MySimpleBeanInfo {

	public GetDocumentAttachmentTransactionBeanInfo() {
		try {
			beanClass = GetDocumentAttachmentTransaction.class;
			additionalBeanClass = AbstractDocumentTransaction.class;

			resourceBundle = getResourceBundle("res/GetDocumentAttachmentTransaction");
			
			displayName = getExternalizedString("display_name");
			shortDescription = getExternalizedString("short_description");

			iconNameC16 = "/com/twinsoft/convertigo/beans/transactions/couchdb/images/getdocumentattachment_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/transactions/couchdb/images/getdocumentattachment_color_32x32.png";
