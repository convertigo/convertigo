...
public class GetServerConfigTransactionBeanInfo extends MySimpleBeanInfo {
	...
	public GetServerConfigTransactionBeanInfo() {
		try {
			beanClass = GetServerConfigTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/GetServerConfigTransaction");
