...
public class GetServerStatsTransactionBeanInfo extends MySimpleBeanInfo {

	public GetServerStatsTransactionBeanInfo() {
		try {
			beanClass = GetServerStatsTransaction.class;
			additionalBeanClass = AbstractCouchDbTransaction.class;

			resourceBundle = getResourceBundle("res/GetServerStatsTransaction");
			
			displayName = getExternalizedString("display_name");
			shortDescription = getExternalizedString("short_description");

			iconNameC16 = "/com/twinsoft/convertigo/beans/transactions/couchdb/images/getserverstats_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/transactions/couchdb/images/getserverstats_color_32x32.png";
