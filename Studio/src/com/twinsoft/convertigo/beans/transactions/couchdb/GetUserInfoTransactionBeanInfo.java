...
public class GetUserInfoTransactionBeanInfo extends MySimpleBeanInfo {

	public GetUserInfoTransactionBeanInfo() {
		try {
			beanClass = GetUserInfoTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/GetUserInfoTransaction");
