...
public class LogonUserTransaction extends AbstractServerTransaction {
	...
	public LogonUserTransaction() {
		super();
	}

	@Override
	public LogonUserTransaction clone() throws CloneNotSupportedException {
		LogonUserTransaction clonedObject =  (LogonUserTransaction) super.clone();
		return clonedObject;
	}
