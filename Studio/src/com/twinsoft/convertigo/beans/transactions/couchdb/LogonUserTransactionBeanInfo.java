...
public class LogonUserTransactionBeanInfo extends MySimpleBeanInfo {

	public LogonUserTransactionBeanInfo() {
		try {
			beanClass = LogonUserTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/LogonUserTransaction");
