...
public class LogoutUserTransactionBeanInfo extends MySimpleBeanInfo {

	public LogoutUserTransactionBeanInfo() {
		try {
			beanClass = LogoutUserTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/LogoutUserTransaction");
