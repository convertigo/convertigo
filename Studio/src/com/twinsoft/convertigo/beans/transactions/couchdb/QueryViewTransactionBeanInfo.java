...
public class QueryViewTransactionBeanInfo extends MySimpleBeanInfo {

	public QueryViewTransactionBeanInfo() {
		try {
			beanClass = QueryViewTransaction.class;
			additionalBeanClass = AbstractDocumentTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/QueryViewTransaction");
