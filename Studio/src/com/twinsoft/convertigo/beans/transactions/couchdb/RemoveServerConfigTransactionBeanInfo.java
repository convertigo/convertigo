...
public class RemoveServerConfigTransactionBeanInfo extends MySimpleBeanInfo {

	public RemoveServerConfigTransactionBeanInfo() {
		try {
			beanClass = RemoveServerConfigTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/RemoveServerConfigTransaction");
