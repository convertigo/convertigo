...
public class ReplicateDatabaseTransaction extends AbstractDatabaseTransaction {
	...
	public ReplicateDatabaseTransaction() {
		super();
	}

	@Override
	public ReplicateDatabaseTransaction clone() throws CloneNotSupportedException {
		ReplicateDatabaseTransaction clonedObject =  (ReplicateDatabaseTransaction) super.clone();
		return clonedObject;
	}
