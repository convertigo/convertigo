...
public class ReplicateDatabaseTransactionBeanInfo extends MySimpleBeanInfo {

	public ReplicateDatabaseTransactionBeanInfo() {
		try {
			beanClass = ReplicateDatabaseTransaction.class;
			additionalBeanClass = AbstractDatabaseTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/ReplicateDatabaseTransaction");
