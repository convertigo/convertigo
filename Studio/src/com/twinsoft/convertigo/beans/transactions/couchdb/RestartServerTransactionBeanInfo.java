...
public class RestartServerTransactionBeanInfo extends MySimpleBeanInfo {

	public RestartServerTransactionBeanInfo() {
		try {
			beanClass = RestartServerTransaction.class;
			additionalBeanClass = AbstractServerTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/RestartServerTransaction");
