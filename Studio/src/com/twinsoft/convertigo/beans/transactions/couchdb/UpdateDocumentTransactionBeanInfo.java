...
public class UpdateDocumentTransactionBeanInfo extends MySimpleBeanInfo {

	public UpdateDocumentTransactionBeanInfo() {
		try {
			beanClass = UpdateDocumentTransaction.class;
			additionalBeanClass = AbstractDocumentTransaction.class;

			resourceBundle = getResourceBundle("../res/couchdb/UpdateDocumentTransaction");
