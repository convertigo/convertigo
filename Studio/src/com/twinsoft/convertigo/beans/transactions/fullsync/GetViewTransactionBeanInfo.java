...
public class GetViewTransactionBeanInfo extends MySimpleBeanInfo {
	...
	public GetViewTransactionBeanInfo() {
		try {
			...
			additionalBeanClass = com.twinsoft.convertigo.beans.transactions.couchdb.GetViewTransaction.class;
			
			resourceBundle = getResourceBundle("../couchdb/res/GetViewTransaction");
