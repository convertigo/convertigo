...
public class RequestableMultiValuedVariableBeanInfo extends MySimpleBeanInfo {
    
	public RequestableMultiValuedVariableBeanInfo() {
		try {
			...
			resourceBundle = getResourceBundle("res/RequestableMultiValuedVariable");
