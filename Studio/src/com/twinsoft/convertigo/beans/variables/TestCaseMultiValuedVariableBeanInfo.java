...
public class TestCaseMultiValuedVariableBeanInfo extends MySimpleBeanInfo {
    
	public TestCaseMultiValuedVariableBeanInfo() {
		try {
			beanClass = TestCaseMultiValuedVariable.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.variables.TestCaseVariable.class;
