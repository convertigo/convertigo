...
public class TransactionStepEditor {
	static public String[] getColumnNames() {
		return new String[] { "Variable", "Description", "Source", "Default value"};
	}
	
	static public Object[] getDefaultData() {
		return new Object[] { "variable", "description", new XMLVector<XMLVector<Object>>(), ""};
	}
