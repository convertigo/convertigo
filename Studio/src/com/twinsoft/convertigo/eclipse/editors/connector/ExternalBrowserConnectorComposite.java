...
public class ExternalBrowserConnectorComposite extends AbstractConnectorComposite implements ConnectorListener {

	private Text httpData;
	
	public ExternalBrowserConnectorComposite(ConnectorEditorPart connectorEditorPart, Connector connector, Composite parent, int style) {
