...
public class CreateDocumentAction extends DatabaseObjectCreateAction {

	public CreateDocumentAction() {
		super("com.twinsoft.convertigo.beans.core.Document");
	}
		...
		try {
			...
			if (treeObject instanceof ObjectsFolderTreeObject)
				...
				if (dbo instanceof Connector)
					enable = dbo instanceof CouchDbConnector;
			}
