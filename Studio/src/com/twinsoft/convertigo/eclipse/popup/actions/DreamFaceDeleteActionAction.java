...
public class DreamFaceDeleteActionAction extends DreamFaceAbstractAction {

	public DreamFaceDeleteActionAction() {
		super();
	}
	...
	public void run() {
        ...
        try {
    		...
    		if (explorerView != null) {
    			...
    			MashupActionDialog mashupDialog = new MashupActionDialog(shell, MashupActionDialog.TYPE_DELETE, mdc, mac);
	        	mashupDialog.open();
	    			...
	    			if ((dataview != null) && (!dataview.equals(""))) {
	    				if (securedLogin()) {
		    				try {
				    			...
				    			String dfResponse = deleteResponseAction(requestable, dataview);
	...
	private String deleteResponseAction(RequestableObject requestable, String dataview) throws HttpException, IOException, ParserConfigurationException, SAXException, DreamFaceInvalidTemplateException {
		Hashtable<String, String> fields = getResponseFields(DELETE_ACTION_TYPE, requestable, dataview);
