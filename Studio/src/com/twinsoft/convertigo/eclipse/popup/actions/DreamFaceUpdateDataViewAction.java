...
public class DreamFaceUpdateDataViewAction extends DreamFaceAbstractAction {

	public DreamFaceUpdateDataViewAction() {
		super();
	}
	...
	public void run() {
        ...
        try {
    		...
    		if (explorerView != null) {
	    		...
	    		if (mashupDialog.getReturnCode() != Window.CANCEL) {
	    			...
	    			if ((dataview != null) && (!dataview.equals(""))) {
	    				if (securedLogin()) {
			    			try {
				    			String dfRequest = updateRequestDataView(requestable, dataview);
				    			if (!dfRequest.equals("")) {
				    		...
				    		try {
				    			String dfResponse = updateResponseDataView(requestable, dataview);
        	...
        	ConvertigoPlugin.logException(e, "Unable to update dataview(s) to DreamFace!");
        }
        finally {
	...
	private String updateRequestDataView(RequestableObject requestable, String dataview) throws HttpException, IOException, DreamFaceInvalidTemplateException {
        ...
        return updateDataView(dataviewName,fields);
	}
	
	private String updateResponseDataView(RequestableObject requestable, String dataview) throws HttpException, IOException, ParserConfigurationException, SAXException, DreamFaceInvalidTemplateException {
