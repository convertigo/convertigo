...
public class SequenceEditWSDLTypeAction extends MyAbstractAction {

	public SequenceEditWSDLTypeAction() {
		super();
	}
	...
	public void run() {
		...
		try {
			...
			ConvertigoPlugin.logException(e, "Unable to edit the WSDL for sequence!");
		} finally {
