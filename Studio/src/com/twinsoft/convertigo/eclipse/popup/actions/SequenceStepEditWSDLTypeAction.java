...
public class SequenceStepEditWSDLTypeAction extends MyAbstractAction {
	...
	public SequenceStepEditWSDLTypeAction() {
		super();
	}
	...
	public void run() {
		...
		try {
			...
			if (explorerView != null) {
				...
				((IEditableTreeObject) treeObject).launchEditor("XMLSequenceStepEditor");
			}
		} catch (Throwable e) {
			ConvertigoPlugin.logException(e, "Unable to edit the WSDL for sequence step!");
		} finally {
