...
public class HttpTriggerDocumentCompletedEditorComposite extends AbstractHttpTriggerCustomEditorComposite{
	private Label nbdoc_label = null;
	private Spinner nbdoc_spin = null;
	...
	public TriggerXMLizer getTriggerXMLizer(){
		return new TriggerXMLizer(new DocumentCompletedTrigger(nbdoc_spin.getSelection(),parent.getTimeout()));
	}
