 ...
 *
 * $URL: http://sourceus.twinsoft.fr/svn/CEMS/trunk/Studio/src/com/twinsoft/convertigo/eclipse/property_editors/SheetLocationEditor.java $
 * $Author: fabienb $
 * $Revision: 28379 $
...
public class RequestableAccessibilityEditor extends PropertyWithTagsEditor {
    ...
    public static String[] getTags(DatabaseObjectTreeObject databaseObjectTreeObject) {
    	return new String[] { PUBLIC, HIDDEN, PRIVATE };
    }
