...
public class NewProjectWizardComposite4 extends Composite  {
	...
	private Label serviceCode = null; 

	public NewProjectWizardComposite4(Composite parent, int style, IWizard wizard) {
		super(parent, style);
		...
		wz.page7.textHostName.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				serviceCode.setText(wz.page7.getServiceCode());
			}
		});
		wz.page7.textHostPort.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				serviceCode.setText(wz.page7.getServiceCode());
			}
		});
		wz.page7.textConnectionParameter.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				serviceCode.setText(wz.page7.getServiceCode());
			}
		});
	...
	private void initialize() {
		...
		serviceCode = new Label(this, SWT.NONE);
		serviceCode.setText("service code");
		serviceCode.setLayoutData(gridData6);
