...
public class DatabaseObjectsManager implements AbstractManager {
	...
	public void reload(DatabaseObject databaseObject, boolean bRecursively) throws EngineException,
			DatabaseObjectNotFoundException {
		...
		if (bRecursively) {
			if (databaseObject instanceof Project) {
				...
				if (databaseObject instanceof IScreenClassContainer) {
					ScreenClass defaultScreenClass = ((IScreenClassContainer<?>) databaseObject)
