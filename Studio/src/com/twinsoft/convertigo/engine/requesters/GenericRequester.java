    	...
    	try {
    		...
    		if (context != null) {
    			...
    			if (Engine.logStatistics.isInfoEnabled()) {
    				...
    				//stats = context.statistics.printStatisticsXML();
...
//	protected Object addStatisticsAsText(String stats, Object result) throws Exception {
//		if (result != null) {
...
//            }
            //TODO get the xmlstatistics boolean
