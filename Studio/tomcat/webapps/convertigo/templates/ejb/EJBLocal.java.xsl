...
/**
 * Local interface for <xsl:call-template name="getClassNameOfCurrent"/>EJB.
 * Automatically generated by twinsoft Convertigo.
 */
public interface <xsl:call-template name="getClassNameOfCurrent"/>EJBLocal extends javax.ejb.EJBLocalObject{
