...
<header
	class="sticky top-0 z-20 flex justify-between border-b-[0.5px] border-color preset-filled-surface-50-950 shadow-md/30 shadow-primary-100-900 hover:shadow-md/60"
>
