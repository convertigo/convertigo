...
public class CreateNgxUIComponentAction extends NgxComponentCreateAction {
	public CreateNgxUIComponentAction() {
		super("com.twinsoft.convertigo.beans.ngx.components.UIComponent");
	}
