...
public class NgxSmartSourcePropertyDescriptor extends PropertyDescriptor {
	public DatabaseObjectTreeObject databaseObjectTreeObject;
	private boolean readOnly = false;
	private String[] labels;
	
	public NgxSmartSourcePropertyDescriptor(Object id, String displayName, String[] labels, boolean readOnly) {
    ...
    public CellEditor createPropertyEditor(Composite parent) {
    	NgxSmartSourceTypeCellEditor editor = new NgxSmartSourceTypeCellEditor(parent, readOnly ? SWT.READ_ONLY:SWT.NONE, labels);
