...
public class NgxPickerView extends ViewPart implements ISelectionListener {
	private NgxPickerComposite mpc;
	
	public NgxPickerView() {
		
	}

	@Override
	public void createPartControl(Composite parent) {
		mpc = new NgxPickerComposite(parent, false);
