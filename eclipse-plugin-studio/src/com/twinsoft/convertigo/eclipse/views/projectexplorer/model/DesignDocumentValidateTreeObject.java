...
import com.twinsoft.convertigo.eclipse.views.projectexplorer.model.DesignDocumentTreeObject.ValidateObject;
...
public class DesignDocumentValidateTreeObject extends DesignDocumentFunctionTreeObject {
	...
	@Override
	public ValidateObject getObject() {
		return (ValidateObject) super.getObject();
	}
