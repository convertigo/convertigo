...
//    }    
    ...
    {
        try {
			return Class.forName("org.apache.xml.serializer.dom3.DOM3SerializerImpl").getConstructor(SerializerBase.class).newInstance(this);
		} catch (Exception e) {
			throw new IOException("Cannot find org.apache.xml.serializer.dom3.DOM3SerializerImpl", e);
		}
    }
    /**
