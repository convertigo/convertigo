...
public class UICustomBeanInfo extends MySimpleBeanInfo {
	
	public UICustomBeanInfo() {
		try {
			beanClass = UICustom.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.mobile.components.UIComponent.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/mobile/components/images/uicustom_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/mobile/components/images/uicustom_color_32x32.png";

			resourceBundle = getResourceBundle("res/UICustom");
