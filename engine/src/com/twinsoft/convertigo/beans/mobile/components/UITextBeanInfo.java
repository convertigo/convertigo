...
public class UITextBeanInfo extends MySimpleBeanInfo {
	...
	public UITextBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/mobile/components/images/uitext_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/mobile/components/images/uitext_color_32x32.png";

			resourceBundle = getResourceBundle("res/UIText");
