...
public class UIAppGuardBeanInfo extends MySimpleBeanInfo {
	
	public UIAppGuardBeanInfo() {
		try {
			...
			properties[0] = new PropertyDescriptor("guardType", beanClass, "getGuardType", "setGuardType");
			properties[0].setDisplayName(getExternalizedString("property.guardType.display_name"));
			properties[0].setShortDescription(getExternalizedString("property.guardType.short_description"));
			properties[0].setPropertyEditorClass(getEditorClass("StringComboBoxPropertyDescriptor"));
			
			getPropertyDescriptor("topic").setHidden(true);
		}
		catch(Exception e) {
