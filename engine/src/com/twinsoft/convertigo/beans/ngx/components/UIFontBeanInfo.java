...
public class UIFontBeanInfo extends MySimpleBeanInfo {
	...
	public UIFontBeanInfo() {
		try {
			...
			iconNameC16 = "/com/twinsoft/convertigo/beans/ngx/components/images/uifont_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/ngx/components/images/uifont_color_32x32.png";

			resourceBundle = getResourceBundle("res/UIFont");
