...
public class UIFormCustomValidatorBeanInfo extends MySimpleBeanInfo {
	...
	public UIFormCustomValidatorBeanInfo() {
		try {
			...
			additionalBeanClass = com.twinsoft.convertigo.beans.ngx.components.UIFormValidator.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/ngx/components/images/uiformvalidator_color_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/ngx/components/images/uiformvalidator_color_32x32.png";
			...
			properties[0] = new PropertyDescriptor("validatorValue", beanClass, "getValidatorValue", "setValidatorValue");
