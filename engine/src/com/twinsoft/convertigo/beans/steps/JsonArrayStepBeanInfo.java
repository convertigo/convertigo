...
public class JsonArrayStepBeanInfo extends MySimpleBeanInfo {
	
	public JsonArrayStepBeanInfo() {
		try {
			beanClass = JsonArrayStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.StepWithExpressions.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/jsonarray_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/jsonarray_32x32.png";
			
			resourceBundle = getResourceBundle("res/JsonArrayStep");
