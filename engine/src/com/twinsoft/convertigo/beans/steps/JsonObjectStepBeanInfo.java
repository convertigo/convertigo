...
public class JsonObjectStepBeanInfo extends MySimpleBeanInfo {
	
	public JsonObjectStepBeanInfo() {
		try {
			beanClass = JsonObjectStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.StepWithExpressions.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/jsonobject_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/jsonobject_32x32.png";
			
			resourceBundle = getResourceBundle("res/JsonObjectStep");
