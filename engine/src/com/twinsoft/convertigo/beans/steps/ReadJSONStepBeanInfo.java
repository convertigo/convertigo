...
public class ReadJSONStepBeanInfo extends MySimpleBeanInfo{

	public ReadJSONStepBeanInfo() {
		try {
			beanClass = ReadJSONStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.steps.ReadFileStep.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/jsonR_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/jsonR_32x32.png";

			resourceBundle = getResourceBundle("res/ReadJSONStep");
			...
			properties[2] = new PropertyDescriptor("arrayChildrenTag", beanClass, "getArrayChildrenTag", "setArrayChildrenTag");
			properties[2].setDisplayName(getExternalizedString("property.arrayChildrenTag.display_name"));
			properties[2].setShortDescription(getExternalizedString("property.arrayChildrenTag.short_description"));
