 ...
 *
 * $URL: http://sourceus/svn/convertigo/CEMS_opensource/trunk/Studio/src/com/twinsoft/convertigo/beans/steps/SessionSetStepBeanInfo.java $
 * $Author: $
 * $Revision: $
 * $Date: $
 */
...
public class SessionSetObjectStepBeanInfo extends MySimpleBeanInfo {
    
	public SessionSetObjectStepBeanInfo() {
		try {
			beanClass = SessionSetObjectStep.class;
			additionalBeanClass = com.twinsoft.convertigo.beans.core.Step.class;

			iconNameC16 = "/com/twinsoft/convertigo/beans/steps/images/sessionSetObject_16x16.png";
			iconNameC32 = "/com/twinsoft/convertigo/beans/steps/images/sessionSetObject_32x32.png";
			
			resourceBundle = getResourceBundle("res/SessionSetObjectStep");
