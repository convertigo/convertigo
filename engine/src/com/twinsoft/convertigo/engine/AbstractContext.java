...
public abstract class AbstractContext {
	 ...
	 */
	public transient String servletPath;
	 ...
	 */
	public transient String remoteAddr;
	
	/**
	 * The name of the calling client (if reverse DNS has been enabled).
	 */
	public transient String remoteHost;
...
//	public String portalUserName;
	 ...
	 */
	public transient Document inputDocument;
	
	/**
	 * The output XML document generated by the current transaction.
	 */
	public transient Document outputDocument;
	
	/**
	 * The steps objects, useful for asynchronous transaction.
	 */
	public transient List<String> steps;
