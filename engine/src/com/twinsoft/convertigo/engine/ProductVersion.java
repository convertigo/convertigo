...
public class ProductVersion {
    ...
    public static String tag = "patch-20230629"; // To be modified by patch-YYYYMMDD at each patch generation (check build.gradle for files to be included in patch)!!
