 ...
 * License along with Convertigo; if not, see <http://www.gnu.org/licenses/>.
 */
...
public class Save extends JSonService {
	...
	protected void getServiceResult(HttpServletRequest request, JSONObject response) throws Exception {
		...
		if (projectName != null && !projectName.isBlank()) {
			...
			throw new ServiceException("missing projectName or id parameter");
		}
		...
		response.put("message", "Project has been saved.");
	}
}
