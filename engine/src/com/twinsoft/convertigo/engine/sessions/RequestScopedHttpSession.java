...
public final class RequestScopedHttpSession implements HttpSession, AutoCloseable {
	...
	// Servlet 4 (javax) still declares the deprecated value accessors removed from Jakarta Servlet 6.
	@Override
	...
	public String[] getValueNames() {
		return java.util.Collections.list(getAttributeNames()).toArray(String[]::new);
	}
